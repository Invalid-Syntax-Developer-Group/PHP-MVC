...
namespace PhpMVC\Framework\Email;

use Closure;
use PhpMVC\Framework\Email\Driver\Driver;
use PhpMVC\Framework\Email\Exception\DriverException;
 ...
 *
 * @package PhpMVC\Framework\Email
 * @since   1.0
 */
